...
order: 4
---
<!-- https://homebrewery.naturalcrit.com/edit/8m8EZXZIJb3B -->
...
> ___
>
> ***Music Lover.*** Badger moles are pacified by the sounds of music.
>
> ***Keen Smell.*** The badgermole has advantage on Wisdom (Perception) checks that rely on smell.
>
> ***Burrow.*** Badgermoles cannot burrow into solid rock, but they can move through softer material like soil or loose rubble, leaving a usable tunnel 5 feet in diameter.
>
> ### Actions
> ***Multiattack.*** The badgermole makes one claw attack and one bite attack.
>
...
>
>___
>***Pack Tactics.*** The buzzard wasp has advantage on an attack roll against a creature if at least one of the vulture's allies is within 5 feet of the creature and the ally isn't incapacitated.
>### Actions
>***Multiattack.*** The buzzard wasp makes two attacks: one with its beak and one with its stinger.
>
>***Beak.*** *Melee Weapon Attack:* +4 to hit, reach 5 ft., one target. *Hit:* 7 (2d4 + 2) piercing damage.
>
>***Sting.*** *Melee Weapon Attack:* +4 to hit, reach 5 ft., one creature. *Hit:* 5 (1d6 + 2) piercing damage, and the target must make a DC 11 Constitution saving throw, taking 10 (3d6) poison damage on a failed save, or half as much damage on a successful one. If the poison damage reduces the target to 0 hit points, the target is stable but poisoned for 1 hour, even after regaining hit points, and is paralyzed while poisoned in this way.

<!-- > ***Sting (alt.)*** Melee Weapon Attack: +4 to hit, reach 5 ft., one target. *Hit:* 9 (2d6 + 2) slashing damage.-->
...
>
> ___
> ***Keen Smell.*** The canyon crawler has advantage on Wisdom (Perception) checks that rely on smell.
> 
> ***Spider Climb.*** The canyon crawler can climb difficult surfaces, including upside down on ceilings, without needing to make an ability check.
> ### Actions
> ***Multiattack.*** The canyon crawler makes two attacks: one with its bite and one with its claws.
>
...
<!-- need to rewatch "The Great Divide" -->
...
>
> ___
> ***Amphibious.*** The catgator can breathe air and water.
> ### Actions
...
<!--
<div style="width: 220px; overflow: hidden; margin: 0; float: left;">
<img src='https://static.wikia.nocookie.net/avatar/images/6/6c/Slim.png' style='margin-left: -30px; width: 100%'/></div><div style="width: 100px; overflow: hidden; margin: 0; float: left;">
<img src='https://static.wikia.nocookie.net/avatar/images/6/6b/Elbow_leech.png' style='margin: 0 -50px;'/></div>
...
> ### Actions
> ***Bite.*** *Melee Weapon Attack:* +2 to hit, reach 5 ft., one creature. *Hit:* 1 piercing damage, and the leech attaches to the target.   
> While attached, the leech can't attack and the target takes 1 damage at the start of each of the leech's turns as it loses blood.  
> The leech can spend 5 feet of movement to detach itself. It automatically does so after draining 5 hit points of blood from the target or when the target dies. A creature, including the target, can use its action to detach the leech.

<div class="HBonly" style="width: 100px; overflow: hidden; margin: 0; float: left;">
<img src='https://static.wikia.nocookie.net/avatar/images/6/6b/Elbow_leech.png' style='margin: 0 -50px;'/>
</div>
<div class="HBonly" style="width: 220px; overflow: hidden; margin-left: 4px; padding-bottom: 9px; margin-bottom: 4px; float: left;">
<img src='https://static.wikia.nocookie.net/avatar/images/f/f2/Giant_rhinoceros_beetle.png' style='margin: -10px 0px;'/></div>
...
>
> ___
> ***Airbending.*** Sky bison know the airbending form *Gust* and can use it at will by spending an action.
> ### Actions
...
> ___
> ### Actions
> ***Horn.*** *Melee Weapon Attack:* +6 to hit, reach 5ft., one target. *Hit* 9 (2d4 + 4) bludgeoning damage. <div class="wide"></div>

<!-- Draft Horse, Elephant, and Giant Fire Beetle -->
...
>
> ***Messenger.*** Given a message and the name of a location it has visited before or simple directions (less than 5 words), the hawk will deliver the message and return.
> ### Actions
> ***Talons.*** *Melee Weapon Attack:* +5 to hit, one target. *Hit:* 1 slashing damage.

<div class="HBonly" style="text-align: center;">
<img src='https://static.wikia.nocookie.net/avatar/images/2/2f/Hawky.png' style='height:200px;'/></div>
...
Consulted Lion stat block but didn't use it: https://www.dndbeyond.com/monsters/lion
-->
<hr class="HBonly">
...
>___
>
> - **Saving Throws** Cha +10, Con +11, Wis +7 
...
> 
> ***Elemental.*** Each lion turtle is connected to one of the four elements, indicated by the symbol on its forehead. 
> 
> Lion turtles possess the *energybending* ability (described in the Monk class). A lion turtle can use this ability to remove a creature's bending of the element the lion turtle is associated with. 
>
> It can also grant a willing creature the ability to bend this element, regardless of whether the target already bends another element, had its bending blocked by energybending, bloodbending, or other means, or is not a bender.
>
> Air lion turtles additionally have a flying speed of 20 ft.
>
> ***Camouflaged Body.*** As it grows larger and older, a lion turtle's shell develops plant life which starts to sustain an entire forest ecosystem. When floating on water, a lion turtle easily passes as a small island.
> ### Actions
> ***Multiattack.*** The lion turtle makes three attacks: one with its bite and two with its claws. It can make one tail attack in place of its two claw attacks.
>
> ***Bite.*** *Melee Weapon Attack:* +13 to hit, reach 15 ft., one target. *Hit:* 26 (3d12 + 7) piercing damage. 
>
> ***Claw.*** *Melee Weapon Attack:* +13 to hit, reach 10 ft., one target. *Hit:* 16 (2d8 + 7) slashing damage.
>
> ***Tail.*** *Melee Weapon Attack:* +13 to hit, reach 15 ft., one target. *Hit:* 26 (3d12 + 7) bludgeoning damage. If the target is a creature, it must succeed on a DC 20 Strength saving throw or be pushed up to 10 feet away from the lion turtle and knocked prone.
> <div class='wide'></div>
...
>
> ___
> ***Keen Smell.*** The platypus bear has advantage on Wisdom (Perception) checks that rely on smell.
>
> ***Lay Egg.*** When frightened, the platypus bear will unintentionally lay an egg. The egg is safe to eat once cooked.
> ### Actions
>  ***Multiattack.*** The platypus bear makes two attacks: one with its bite and one with its claws.
> 
...
>
> ***Pack Tactics.*** The polar bear dog has advantage on an attack roll against a creature if at least one of the dog's allies is within 5 feet of the creature and the ally isn't incapacitated.
> ### Actions
...
>
> ___
> ***Hold Breath.*** While out of water, the purple pentapus can hold its breath for 30 minutes.
> 
> ***Water Breathing.*** The purple pentapus can breathe only underwater.
> ### Actions
> ***Suction.*** *Melee Attack:* +4 to hit, reach 5ft., one target. On a hit, the purple pentapus attaches to the target. The purple pentapus can spend 5 feet of movement to detach. Alternatively, it detaches when a creature scratches it on the head.  
> 
> The area the purple pentapus was attached to remains covered in pink dots for 30 minutes after it detaches.
...
The serpent inhavits the lakes surrounding the Serpent's Pass in the Earth Nation. It generally subsists on aquatic creatures, but will eat anything that comes across its path, including ships and the rare humans who brave the Serpent's Pass. Before attacking, it lets out a bloodcurdling scream.
</div>
...
> ### Actions
> ***Bite.*** *Melee Weapon Attack:* +9 to hit, reach 10 ft., one target. *Hit* 19 (2d12 + 6) piercing damage.
>
...
> ### Actions
> ***Bite.*** *Melee Weapon Attack:* +4 to hit, one target. *Hit:* 4 (1d8) piercing damage.
><div class="wide"></div>
  
<div class="HBonly wide" style="text-align: center;">
...
>
> ___
> ***Protective.*** Turtle ducks are gentle creatuers and usually avoid a fight. If it perceives a threat to its young, however, a turtle duck will attack.
> ### Actions
...
>
> ***Pack Tactics.*** The winged lemur has advantage on an attack roll against a creature if at least one of the lemur's allies is within 5 feet of the creature and the ally isn't incapacitated.
> ### Actions
> ***Slam.*** *Melee Weapon Attack:* +1 to hit, one target. *Hit:* 1 (1d4 - 1) bludgeoning damage.
...
- [Badgermole](https://avatar.fandom.com/wiki/Badgermole) - Lady Lostris
- [Buzzard Wasp](https://avatar.fandom.com/wiki/Buzzard_wasp) - Lady Lostris
- [Canyon Crawler](https://avatar.fandom.com/wiki/Canyon_crawler) - Lady Lostris
- [Catgator](https://avatar.fandom.com/wiki/Catgator) - Lady Lostris
- [Elbow Leech](https://avatar.fandom.com/wiki/Elbow_leech) - Lady Lostris
- [Flying Bison](https://avatar.fandom.com/wiki/Flying_bison) - Lady Lostris
- [Giant Rhinoceros Beetle](https://avatar.fandom.com/wiki/Giant_rhinoceros_beetle) - Lady Lostris
- [Gilacorn](https://avatar.fandom.com/wiki/Gilacorn) - Lady Lostris
- [Hawk (Messenger)](https://avatar.fandom.com/wiki/Hawky) - Ruen
- [Lion Turtle](https://avatar.fandom.com/wiki/Lion_turtle) - Lady Lostris
- [Otter Penguin](https://avatar.fandom.com/wiki/Otter_penguin) - Lady Lostris
- [Platypus Bear](https://avatar.fandom.com/wiki/Platypus_bear) - Lady Lostris
- [Polar Bear Dog](https://avatar.fandom.com/wiki/Polar_bear_dog) - KettleMeetPot
